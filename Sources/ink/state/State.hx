...
class State {
	...
	function init(app:Application) {
		...
		onInit();
		info('State ${Type.getClassName(Type.getClass(this))} initialized', 2);
	}
	...
	function resume() {
		...
		onResumed();
		info('State ${Type.getClassName(Type.getClass(this))} resumed', 2);
	}
	...
	function foreground() {
		...
		onForeground();
		info('State ${Type.getClassName(Type.getClass(this))} foregrounded', 2);
	}
	...
	function background() {
		onBackground();
		info('State ${Type.getClassName(Type.getClass(this))} backgrounded', 2);
	...
	function suspend() {
		onSuspend();
		info('State ${Type.getClassName(Type.getClass(this))} suspended', 2);
	...
	function destroy() {
		onDestroy();
		info('State ${Type.getClassName(Type.getClass(this))} destroyed', 2);
